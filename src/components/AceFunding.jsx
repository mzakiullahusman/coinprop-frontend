    ...
    >
      <div className="px-4 md:px-12 py-5 md:py-10">
        <div className="flex flex-col gap-y-2 justify-center items-center">
          ...
          <div
            className={`text-[28px] tracking-[-1px] xl:tracking-[-4px] xl:leading-[80px] text-white ${
              text === "Works" &&
              "text-center xl:w-[43%] text-[36px] lg:text-[60px] xl:text-[84px] xl:leading-[90px]"
            } lg:text-[50px] xl:text-[64px] font-redhat font-medium`}
          >
            {title}
          </div>
