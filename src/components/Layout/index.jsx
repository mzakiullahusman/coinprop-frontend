...
const Layout = ({ children }) => {
  ...
  const menuItem = [
    ...
    // {
    //   id: 7,
    //   path: "/dashboard/profit-and-share",
    ...
    {
      id: 5,
      path: "/dashboard/affiliate-portal",
      name: "Affiliate Portal",
      icon: <AffiliateIcon />,
    },
    {
      id: 6,
      path: "/dashboard/billing-and-accounts",
      name: "Billing",
